...
const syncRequestExample = `{ "sceneCode": "CANTEEN_DEDUCTION", "sceneParams": { "amount": 12.50, "merchantName": "食堂一楼", "consumeTime": "2026-05-27 12:15:00", "balance": 987.50 }, "userId": "U123456", "userOrgId": "ORG_GZPSB", "userPhone": "138****8000", "priority": "NORMAL", "bizId": "ORDER_20260527_001" }`

const syncResponseExample = `{ "code": 200, "message": "推送完成", "data": { "msgId": "MSG_20260527_00001", "status": "SUCCESS", "channelResults": [ { "channelType": "SMS", "status": "SUCCESS", ... } ] } }`
</script>
  ...
  <div class="page-stack push-page">
    ...
    <el-card class="page-card document-card example-card" shadow="never">
      ...
      <div class="example-block">
        ...
        <pre><code>{{ syncRequestExample }}</code></pre>
      </div>
      <div class="example-block">
        <h3>响应体：</h3>
